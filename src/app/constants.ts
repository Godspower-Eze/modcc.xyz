...
////////////////////////////////////////////////////////
export const UNIVARIATE_LAGRANGE_INTERPOLATION_DEFAULT_EVALUATION_POINT = "3";
...
export const MULTILINEAR_LAGRANGE_DEFAULT_STEPS: MultilinearLagrangeInterpolationStepsAndEvaluations =
  {
    multilinear_lagrange_polynomial_steps: [
      ...
      },
      {
        ...
        step_2: {
          lhs: "            ",
          rhs: "$(1 - x_{1})(1 - x_{2})(x_{3})$",
        },
        step_3: {
          lhs: "            ",
          rhs: "$x_{1} +16x_{1}x_{2} +16x_{1}x_{3} +x_{1}x_{2}x_{3} $",
        },
      },
      {
        step_1: {
        ...
        step_2: {
          lhs: "            ",
          rhs: "$(1 - x_{1})(x_{2})(1 - x_{3})$",
        },
        step_3: {
          lhs: "            ",
          rhs: "$x_{2} +16x_{1}x_{2} +16x_{2}x_{3} +x_{1}x_{2}x_{3}$",
        },
      },
      {
        step_1: {
        ...
        step_2: {
          lhs: "            ",
          rhs: "$(1 - x_{1})(x_{2})(x_{3})$",
        },
        step_3: {
          lhs: "            ",
          rhs: "$x_{1}x_{2} + 16x_{1}x_{2}x_{3}$",
        },
      },
      {
        step_1: {
        ...
        step_2: {
          lhs: "            ",
          rhs: "$(x_{1})(1 - x_{2})(1 - x_{3})$",
        },
        step_3: {
          lhs: "            ",
          rhs: "$x_{3} +16x_{1}x_{3} +16x_{2}x_{3} +x_{1}x_{2}x_{3}$",
        },
      },
      {
        step_1: {
        ...
        step_2: {
          lhs: "            ",
          rhs: "$(x_{1})(1 - x_{2})(x_{3})$",
        },
        step_3: {
          lhs: "            ",
          rhs: "$x_{1}x_{3} +16x_{1}x_{2}x_{3}$",
        },
      },
      {
        step_1: {
        ...
        step_2: {
          lhs: "            ",
          rhs: "$(x_{1})(x_{2})(1 - x_{3})$",
        },
        step_3: {
          lhs: "            ",
          rhs: "$x_{2}x_{3} +16x_{1}x_{2}x_{3}$",
        },
      },
      {
        step_1: {
